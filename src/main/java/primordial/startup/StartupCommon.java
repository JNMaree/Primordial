...
import primordial.blocks.ClayOven;

public class StartupCommon {

    public static ClayOven simple_block;
    public static BlockItem item_simple_block;

    @SubscribeEvent
    public static void onBlocksRegistration(final RegistryEvent.Register<Block> blockRegisterEvent){
        simple_block = (ClayOven) new ClayOven().setRegistryName(Primordial.MODID, "simple_block_RegistryName");
